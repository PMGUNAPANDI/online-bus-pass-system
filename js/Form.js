...
function checkInput() {
    ...
    if (destinationValue === 'Choose Your Destination') {
        ...
        if (dest == "Periyar Bus Stand") {
            payment = Number(1000) * pay
            localStorage.setItem("Payment", payment)
        }
        else if (dest == "M.G.R Bus Stand") {
            payment = Number(1000) * pay
            localStorage.setItem("Payment", payment)
        }
        else if (dest == "Aarapalayam") {
            payment = Number(1200) * pay
            localStorage.setItem("Payment", payment)
        }
        else if (dest == "Thirumangalam") {
            payment = Number(1400) * pay
            localStorage.setItem("Payment", payment)
        }
        else if (dest == "Usilampatti") {
            payment = Number(1600) * pay
            localStorage.setItem("Payment", payment)
        }
    }
}
